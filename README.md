...
> 📌 Los datos viven en el navegador del teléfono (localStorage). Si borras los datos del navegador, se borra el historial — el catálogo y la configuración se pueden reconstruir en un minuto.
